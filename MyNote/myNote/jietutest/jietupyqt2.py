...
from  jietupyqt import  Ui_ScrShot
import sys
...
class MainFrom(QtGui.QWidget):
    ...
    def updateScreenshotLabel(self):
        ...
        self.Ui.labelShow.setPixmap(self.originalPixmap.scaled(self.Ui.labelShow.size(), QtCore.Qt.KeepAspectRatio, QtCore.Qt.SmoothTransformation))
